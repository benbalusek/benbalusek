...
import type { Software } from "@/app/_lib/softwareData";
...
function SoftwareModalContent({ software, onClose }: SoftwareProps) {
  const [showOverlay, setShowOverlay] = useState(false);
  const imageList = software.mediumSrcs;
  ...
  return (
    <Modal
      onClose={onClose}
      ariaLabel={`${software.alt} project details`}
...
export default SoftwareModalContent;
